...
namespace de
{
    ...
    public:
        ...
        void Optimize(int iterations, bool verbose = true)
        {
            ...
            bestCost.open("bestCost.txt");
            std::ofstream bestAgents;
            bestAgents.open("bestAgent.txt");
            ...
            double d = -0.8;            // rho                             |  correlation between spot and volatility
            double e = 0.08;
            for (int i = 0; i < iterations; i++)
            {
                ...
                for (auto agent : m_population)
                {
                    ...
                    for (auto& var : agent)
                    {
                        ...
                        // if(counter == 0){
                        //     kappa << sqrt(pow(var - a, 2))/a << " ";
                        // }else if (counter == 1){
                        //     vbar << sqrt(pow(var - b, 2))/b << " ";
                        // }else if (counter == 2){
                        //     sigma << sqrt(pow(var - c, 2))/c << " ";
                        // }else if (counter == 3){
                        //     rho << sqrt(pow(var - d, 2))/(-1*d) << " ";
                        // }else if (counter == 4){
                        //     v0 << sqrt(pow(var - e, 2))/e << " ";
                        // }
                        counter++;
                    }
                }
                ...
                cost << "[ ";
                for (auto& var: m_minCostPerAgent){
                  cost << var << " ";
                }
                cost << "] ";
                ...
                bestCost << m_minCost << " ";
                bestAgents << "[ ";
                bestAgents<< sqrt(pow(m_population[m_bestAgentIndex][0] - a, 2))/a << " ";
                bestAgents<< sqrt(pow(m_population[m_bestAgentIndex][1] - b, 2))/b << " ";
                bestAgents<< sqrt(pow(m_population[m_bestAgentIndex][2] - c, 2))/c << " ";
                bestAgents<< sqrt(pow(m_population[m_bestAgentIndex][3] - d, 2))/-d<< " ";
                bestAgents<< sqrt(pow(m_population[m_bestAgentIndex][4] - e, 2))/e << " ";
                bestAgents <<"] ";
